...
import { SpendingByCategoryChart, SpendingBySpaceChart, TopSpendingCategoriesTable, SummaryMetricsCards, MonthlyIncomeExpensesChart, BalanceEvolutionChart, ExportButtons } from '@/components/charts'
...
export default function ReportsPage() {
        ...
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-muted-foreground">
              Selecione um espaço no cabeçalho para visualizar os relatórios.
            </p>
          </CardContent>
        </Card>
      </main>
  ...
  return (
    ...
    >
        ...
        <Card>
          <CardHeader className="pb-4">
            ...
            <CardDescription 
              ...
              className="text-sm"
            >
              Configure os filtros para personalizar a análise dos dados financeiros{activeSpaceName ? ` de ${activeSpaceName}` : ''}
            </CardDescription>
          </CardHeader>
      ...
      >
        <h2 id="charts-title" className="sr-only">Gráficos e Análises Financeiras</h2>
        ...
        <Card className="border-dashed">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-sm">
              Mais gráficos e análises serão adicionados em breve
            </CardDescription>
          </CardHeader>
          <CardContent className="p-4 sm:p-6">

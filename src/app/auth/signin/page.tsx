        ...
        <CardHeader className="space-y-4 text-center">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <div className="text-left">
              <h1 className="text-xl font-bold">EC</h1>
              <p className="text-xs text-muted-foreground">Controle de finanças</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <CardDescription>
              Faça login com sua conta Google para acessar o sistema de controle de finanças
            </CardDescription>
          </div>
        </CardHeader>

...
export function SpaceForm({ space, onSuccess, onCancel }: SpaceFormProps) {
  ...
  const isNameValid = nameLength >= SPACE_VALIDATION_RULES.NAME_MIN_LENGTH && 
        ...
        {nameLength > 0 && (
          <div className="rounded-lg bg-muted/50 p-3 space-y-2">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className={`flex items-center gap-2 ${
                SPACE_VALIDATION_RULES.ALLOWED_NAME_PATTERN.test(watchedName || '') ? 'text-green-600' : 'text-muted-foreground'
              }`}>
